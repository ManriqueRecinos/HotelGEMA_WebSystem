...
import com.HotelGema.HotelServer.services.customer.booking.BookingService;
...
public class BookingController {
    ...
    public ResponseEntity<?> getAllBookinsByUserdId(@PathVariable Long userId, @PathVariable int pageNumber){
        try{
